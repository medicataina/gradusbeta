...
const PATIENTS = [
  {id:1,name:'Sandra R. F.',age:58,site:'Mama',week:3,totalWeeks:3,esquema:'40 Gy / 15 fx',alert:'urgency',lastFill:'Hoje',silence:false,tlStart:'22/04',tlEnd:'09/05',tlFollow:'09/06',tlPct:93,tlFollowPct:100,charts:{symptoms:{labels:['Sem 1','Sem 2','Sem 3'],series:[{label:'Fadiga',data:[0,1,3],color:C.blue400},{label:'Dor local',data:[0,1,4],color:C.red400}]},domain:{label:'Pele (radiodermatite)',labels:['Sem 1','Sem 2','Sem 3'],series:[{label:'Radiodermatite',data:[0,1,4],color:C.coral400}]}},alerts:[{date:'07/05',desc:'Radiodermatite score 4 · urgência',level:'red',ack:false},{date:'07/05',desc:'Dor local score 4 · urgência',level:'red',ack:false},{date:'05/05',desc:'Radiodermatite score 3 · atenção',level:'orange',ack:true}]},
  {id:2,name:'Roberto C. M.',age:71,site:'Próstata',week:4,totalWeeks:4,esquema:'60 Gy / 20 fx',alert:'urgency',lastFill:'Hoje',silence:false,tlStart:'15/04',tlEnd:'09/05',tlFollow:'09/06',tlPct:90,tlFollowPct:100,charts:{symptoms:{labels:['Sem 1','Sem 2','Sem 3','Sem 4'],series:[{label:'Frequência urinária',data:[1,2,3,4],color:C.red400},{label:'Urgência',data:[0,1,2,3],color:C.amber400}]},domain:{label:'Sintomas intestinais',labels:['Sem 1','Sem 2','Sem 3','Sem 4'],series:[{label:'Diarreia',data:[0,0,1,3],color:C.coral400}]}},alerts:[{date:'07/05',desc:'Frequência urinária score 4 · urgência',level:'red',ack:false},{date:'04/05',desc:'Diarreia score 3 · atenção',level:'orange',ack:true}]},
  {id:3,name:'Fernanda O. S.',age:45,site:'Mama',week:1,totalWeeks:1,esquema:'26 Gy / 5 fx',alert:'attention',lastFill:'Ontem',silence:false,tlStart:'05/05',tlEnd:'09/05',tlFollow:'09/06',tlPct:60,tlFollowPct:90,charts:{symptoms:{labels:['Dia 1','Dia 2','Dia 3'],series:[{label:'Fadiga',data:[0,1,2],color:C.blue400},{label:'Dor local',data:[0,0,2],color:C.red400}]},domain:{label:'Pele e linfedema',labels:['Dia 1','Dia 2','Dia 3'],series:[{label:'Radiodermatite',data:[0,1,2],color:C.coral400},{label:'Linfedema',data:[0,0,1],color:C.teal400}]}},alerts:[{date:'06/05',desc:'Linfedema score 2 · atenção precoce',level:'orange',ack:false}]},
  {id:4,name:'Paulo H. N.',age:68,site:'Próstata',week:2,totalWeeks:4,esquema:'70 Gy / 28 fx',alert:'normal',lastFill:'Hoje',silence:false,tlStart:'22/04',tlEnd:'20/05',tlFollow:'20/06',tlPct:42,tlFollowPct:80,charts:{symptoms:{labels:['Sem 1','Sem 2'],series:[{label:'Frequência',data:[0,1],color:C.blue400},{label:'Urgência',data:[0,0],color:C.amber400}]},domain:{label:'Fadiga geral',labels:['Sem 1','Sem 2'],series:[{label:'Fadiga',data:[0,1],color:C.coral400}]}},alerts:[]},
  {id:5,name:'Beatriz A. L.',age:55,site:'Mama',week:1,totalWeeks:1,esquema:'Boost 10 Gy / 5 fx',alert:'silence',lastFill:'3 dias',silence:true,silenceDays:'3 dias',tlStart:'05/05',tlEnd:'09/05',tlFollow:'09/06',tlPct:40,tlFollowPct:90,charts:{symptoms:{labels:[],series:[]},domain:{label:'',labels:[],series:[]}},alerts:[]},
  {id:6,name:'Marcos V. T.',age:63,site:'Próstata',week:1,totalWeeks:1,esquema:'36,25 Gy / 5 fx (SBRT)',alert:'attention',lastFill:'Hoje',silence:false,tlStart:'05/05',tlEnd:'09/05',tlFollow:'09/06',tlPct:60,tlFollowPct:90,charts:{symptoms:{labels:['Dia 1','Dia 2','Dia 3'],series:[{label:'Frequência',data:[1,2,2],color:C.blue400},{label:'Urgência',data:[0,1,2],color:C.amber400}]},domain:{label:'Sintomas urinários',labels:['Dia 1','Dia 2','Dia 3'],series:[{label:'Ardência',data:[0,1,2],color:C.coral400}]}},alerts:[{date:'07/05',desc:'Urgência urinária score 2 · observação',level:'orange',ack:false}]},
]
  ...
  return(
    <div style={{padding:16}}>
      ...
      <div style={{background:C.white,border:`0.5px solid ${C.gray100}`,borderRadius:16,overflow:'hidden'}}>
        <div style={{display:'grid',gridTemplateColumns:'2fr 80px 1fr 90px 60px',padding:'8px 16px',background:C.gray50,borderBottom:`0.5px solid ${C.gray100}`}}>
          {['Paciente','Sítio','Esquema','Alerta','Último'].map(h=><div key={h} style={{fontSize:11,color:C.gray400,fontWeight:500}}>{h}</div>)}
        </div>
        {sorted.map((p,i)=>(
          <div key={p.id} onClick={()=>onSelect(p.id)} style={{display:'grid',gridTemplateColumns:'2fr 80px 1fr 90px 60px',alignItems:'center',padding:'12px 16px',borderBottom:i<sorted.length-1?`0.5px solid ${C.gray50}`:'none',cursor:'pointer',opacity:p.silence?0.65:1,transition:'background 0.15s'}}
            ...
            <div style={{fontSize:11,color:C.gray700}}>{p.esquema}</div>
